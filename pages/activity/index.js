...
import AddActivity from '../../src/components/forms/add_activity';
...
function Activity() {
  ...
  useEffect(() => {
    ...
    axios({
      ...
      SetAllData(res.data.activity);
    });
  }, [shouldUpdate]);
  return (
    <>
      <Head>
        <title>Activity - Virtuzone</title>
      </Head>
...
Activity.getLayout = (page) => <SidebarLayout>{page}</SidebarLayout>;
